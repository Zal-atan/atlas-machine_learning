#!/usr/bin/env python3
""" Creates the fasttext_model function"""
...
def fasttext_model(sentences, size=100, min_count=5, negative=5, window=5,
    ...
    window:e maximum distance between the current and predicted word within a sentence
    ...
    model = FastText(sentences, min_count=min_count,
                     vector_size=size, window=window,
